...
import com.plcoding.azzam.exoplayer.isPlayEnabled
import com.plcoding.azzam.exoplayer.isPlaying
import com.plcoding.azzam.exoplayer.isPrepared
...
class MainViewModel @ViewModelInject constructor(
    ...
    fun playOrToggleSong(mediaItem: Song, toggle: Boolean = false) {
        ...
        if (isPrepared && mediaItem.mediaId ==
            curPlaingSong?.value?.getString(METADATA_KEY_MEDIA_ID)) {
